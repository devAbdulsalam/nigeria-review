const companyName = 'Kachabazar';
const companyLink = 'https://kachabazar-psi.vercel.app';
const companyLogo = 'https://imgur.com/DKNDGah';
const expireTime =
	'This link will expire in 15 minutes and can only be used once.';
const contactMail = 'kachabazar@gmail.com';
const supportCenter = 'support@kachabazar.com';
const supportLink = 'support@kachabazar.com';

export const VerifyAccountEmail = ({ link, userName }) => {
	const companyName = 'Kachabazar';
	const companyLink = 'Kachabazar';
	const companyLogo = 'Kachabazar';
	const expireTime =
		'This link will expire in 15 minutes and can only be used once.';
	const contactMail = 'kachabazar@gmail.com';
	const supportCenter = 'support@kachabazar.com';
											...
											<tbody>
												<tr>
													<td style="text-align: center; padding:25px 20px 0;">
														<p style="font-size: 13px;">Copyright © 2021 Kachabazar. All rights reserved. <br><a style="color: #6576ff; text-decoration:none;" href=${companyLink}>${companyName}</a>.</p>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align:center;padding: 20px 30px 40px">
                                                        <p>If you did not make this request, please contact us or ignore this message.</p>
                                                        <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">This is an automatically generated email please do not reply to this email. If you face any issues, please contact us at  kachabazar@gmail.com</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>                                    
